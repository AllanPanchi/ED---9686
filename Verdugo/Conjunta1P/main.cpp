...
int main(int argc, char const *argv[]){
    ...
    while(continuar){
        ...
        std::cout << "6. Buscar los productos registrados en un año" << std::endl;
        ...
        switch(opcion)
        {
            ...
            case 6: // Nueva opción para buscar registros en un año
                 system("cls");
                 std::cout << "Ingrese el año: ";
                 int anio;
                 anio = ValidarDatos::validarEntero();
                 ...
                 while (tmp) {
                        if (tmp->getProducto().getAnioElaboracion() == anio) {
                            ...
                            std::cout << "---------------------" << std::endl;
                            break;  // Se encontró el producto, se puede salir del bucle
                        }
                         tmp = tmp->getSiguiente();
                }
    
                if (!encontrado) {
                std::cout << "No se encontraron productos en el año " << anio << std::endl;
                }
