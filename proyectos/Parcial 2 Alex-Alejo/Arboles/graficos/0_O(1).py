...
ax.plot(x, o_1(x), label='O(1)', color='green')  # Cambiar el color de la línea
# Personalizar los límites de los ejes
ax.set_xlim(0, 10)  # Establecer los límites del eje x
ax.set_ylim(0, 8)   # Establecer los límites del eje y

# Personalizar el gráfico
ax.set_title('Función O(1)', color='white')  # Cambiar el color del título
...
ax.legend()
#ax.grid(color='white', linestyle='--')  # Cambiar el color de las líneas de la grilla
